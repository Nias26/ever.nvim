...
map("n", "<C-l>", "<C-w>l")
-- Open Telescope
map("n", "<C-t>", "<cmd>Telescope<CR>", { desc = "Open Telescope" })
map("n", "<C-t>g", "<cmd>Telescope live_grep<CR>", { desc = "Live Grep" })
map("n", "<C-t>G", "<cmd>Telescope git_files<CR>", { desc = "Git Files" })
map("n", "<F2>", function()
